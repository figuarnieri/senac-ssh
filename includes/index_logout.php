...
<main class="wrap cf login">
	<div class="pc-col-9">
		<div class="login--info ta-c">
			...
			<svg class="login--svg d-b" version="1.1" xmlns="http://www.w3.org/2000/svg" width="365.1px" height="365.1px" viewBox="0 0 365.1 365.1">
	...
	<div class="pc-col-9 -pc-col-2">
		<div class="login--form">
			...
			<form class="d-n" id="formCadastro" action="./" method="POST">
