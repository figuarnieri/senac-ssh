...
<main class="main form wrap cf">
	...
	<form class="pc-col-20" action="includes/category_save.php" method="post">
		<?php if($category_edit){ ?>
		...
		<div class="form--box">
			<div class="cf va-m">
				...
				<div class="pc-col-16"><input class="form--input" type="text" name="Nome" id="Nome" required="" value="<?php echo $category_edit ? utf8_encode($user['nomeCategoria']) : ''?>"></div>
			</div>
			<div class="cf va-m">
				<div class="pc-col-4 ta-r"><label class="form--label" for="Descricao">Descrição</label></div>
				<div class="pc-col-16"><input class="form--input" type="text" name="Descricao" id="Descricao" value="<?php echo $category_edit ? utf8_encode($user['descCategoria']) : ''?>"></div>
			</div>
